  ...
  <div class="flex">
    ...
    >
      <div class="w-[600px] p-8 space-y-8 flex flex-col items-center">
        ...
        <p class="text-[32px] font-medium">Log in to your design account</p>
        ...
        >
          ...
          <UButton type="submit" block size="lg" class="liquid-glass bg-gradient cursor-pointer">{{ $t('signin') }}</UButton>
        </UForm>
        <USeparator size="md" />
